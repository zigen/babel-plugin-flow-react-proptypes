...
Foo.propTypes = {
  a_string: require('react').PropTypes.oneOf(['str']).isRequired,
  a_number: require('react').PropTypes.oneOf([7]).isRequired,
  a_boolean: require('react').PropTypes.oneOf([true]).isRequired,
  a_null: require('react').PropTypes.oneOf([true]).isRequired,
